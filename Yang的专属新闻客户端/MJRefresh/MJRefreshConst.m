...
NSString *const MJRefreshFooterRefreshing = @"你杨哥正在帮你加载更多数据...";

NSString *const MJRefreshHeaderPullToRefresh = @"犹豫个蛋，要拉就拉";
NSString *const MJRefreshHeaderReleaseToRefresh = @"还不快松开！！";
NSString *const MJRefreshHeaderRefreshing = @"你杨哥在给你刷新呢...";
